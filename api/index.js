...
var import_node4 = require("@remix-run/node"), import_node5 = require("@remix-run/node"), import_react8 = require("@remix-run/react");

// app/components/TabNavigation.tsx
var import_react7 = require("@remix-run/react"), import_jsx_dev_runtime8 = require("react/jsx-dev-runtime"), defaultLinkStyles = "group relative min-w-0 flex-1 overflow-hidden bg-white py-4 px-6 text-center text-sm font-medium hover:bg-gray-50 focus:z-10", defaultSpanStyles = "absolute inset-x-0 bottom-0 h-0.5", activeLinkStyles = `text-gray-900 ${defaultLinkStyles}`, activeLinkSpanStyles = `bg-rose-500  ${defaultSpanStyles}`;
function TabNavigation({ tabs: tabs2, optimisticPath }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "px-4 sm:px-0", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "sm:hidden", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("label", { htmlFor: "question-tabs", className: "sr-only", children: "Select a tab" }, void 0, !1, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
        "select",
        {
          ...
          children: tabs2.map((tab) => /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("option", { children: tab.name }, tab.name, !1, {
            fileName: "app/components/TabNavigation.tsx",
            lineNumber: 40,
            columnNumber: 13
          }, this))
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "hidden sm:block", children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
      "nav",
      {
        className: "relative z-0 flex divide-x divide-gray-200 rounded-lg shadow",
        "aria-label": "Tabs",
        children: tabs2.map((tab, tabIdx) => /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
          import_react7.NavLink,
          {
            to: tab.href,
            "aria-current": tab.current ? "page" : void 0,
            className: ({ isActive }) => appendBorders(isActive, tabIdx),
            children: ({ isActive }) => /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(import_jsx_dev_runtime8.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("span", { children: tab.name }, void 0, !1, {
                fileName: "app/components/TabNavigation.tsx",
                lineNumber: 60,
                columnNumber: 19
              }, this),
...
function PreviewBookItemSkeleton({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(import_jsx_dev_runtime9.Fragment, { children: blocks.map((_, idx) => /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(
    "div",
    {
      className: "relative mb-6 flex animate-pulse flex-col divide-y divide-gray-200 rounded-lg bg-white shadow",
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "flex flex-col items-start p-8 md:flex-row", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "mx-auto h-60 w-1/5 flex-shrink-0 rounded-lg bg-gray-300 shadow-md", children: "\xA0" }, void 0, !1, {
          fileName: "app/components/LoadingUI/PreviewBookItemSkeleton.tsx",
          lineNumber: 16,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "w-4/5 py-5 md:py-0 md:pl-10 md:pr-2", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "h-10 w-full animate-pulse rounded bg-gray-300", children: "\xA0" }, void 0, !1, {
            fileName: "app/components/LoadingUI/PreviewBookItemSkeleton.tsx",
            lineNumber: 20,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "mt-3 h-6 w-7 animate-pulse rounded bg-gray-300", children: "\xA0" }, void 0, !1, {
            fileName: "app/components/LoadingUI/PreviewBookItemSkeleton.tsx",
            lineNumber: 23,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "mt-4 h-6 w-full animate-pulse rounded bg-gray-300", children: "\xA0" }, void 0, !1, {
            fileName: "app/components/LoadingUI/PreviewBookItemSkeleton.tsx",
            lineNumber: 26,
            columnNumber: 15
          }, this),
...
// app/routes/__home.tsx
var import_jsx_dev_runtime10 = require("react/jsx-dev-runtime"), tabs = [
...
async function loader3({ request }) {
  let { session } = await getSession(request);
  return session ? (0, import_node5.json)({}) : (0, import_node4.redirect)(FAILURE_REDIRECT);
}
function HomeOverview() {
  var _a;
  let transition = (0, import_react8.useNavigation)(), paths = ["/home", "/bookmarks", "/read"], isLoading = (transition == null ? void 0 : transition.state) === "loading" && paths.includes(transition.location.pathname);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(import_jsx_dev_runtime10.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { className: "mt-4", children: isLoading ? /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(PreviewBookItemSkeleton, {}, void 0, !1, {
      fileName: "app/routes/__home.tsx",
      lineNumber: 36,
      columnNumber: 22
    }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(import_react8.Outlet, {}, void 0, !1, {
      fileName: "app/routes/__home.tsx",
      lineNumber: 36,
      columnNumber: 52
    }, this) }, void 0, !1, {
...
function ErrorBoundary2({ error }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(import_jsx_dev_runtime10.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("pre", { children: error.message }, void 0, !1, {
      fileName: "app/routes/__home.tsx",
      lineNumber: 46,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("p", { children: "There was an error in the Home route!" }, void 0, !1, {
      fileName: "app/routes/__home.tsx",
      lineNumber: 47,
      columnNumber: 7
    }, this)
...
function PreviewBookItem({
  ...
  return !book.image || !book.title ? null : /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
    "li",
    {
      className: "flex flex-col divide-y divide-gray-200 rounded-lg bg-white shadow",
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { className: "flex flex-col items-start p-8 md:flex-row", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { className: "w-1/5", children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
            "img",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { className: "w-4/5 py-5 md:py-0 md:px-10", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("h3", { className: "text-xl font-black text-gray-700", children: book.title }, void 0, !1, {
              fileName: "app/components/PreviewBookItem.tsx",
              lineNumber: 34,
              columnNumber: 11
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("dl", { className: "mt-1 flex flex-grow flex-col justify-between", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("dd", { className: "mt-1 mb-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("span", { className: "rounded-full bg-green-100 px-2 py-1 text-xs font-medium text-green-800", children: book.title }, void 0, !1, {
                fileName: "app/components/PreviewBookItem.tsx",
                lineNumber: 37,
                columnNumber: 15
              }, this) }, void 0, !1, {
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("dt", { className: "sr-only", children: "Role" }, void 0, !1, {
                fileName: "app/components/PreviewBookItem.tsx",
                lineNumber: 46,
                columnNumber: 13
              }, this)
...
function Bookmarks() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("h1", { className: "sr-only font-monty text-xl", children: "Discover - latest!" }, void 0, !1, {
      fileName: "app/routes/__home/bookmarks.tsx",
      lineNumber: 24,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("ul", { className: "flex flex-col gap-6", children: bookmarks.map((book, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(
      PreviewBookItem,
      {
        book,
...
function ErrorBoundary3({ error }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(import_jsx_dev_runtime12.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("h1", { children: "Oh no!" }, void 0, !1, {
      fileName: "app/routes/__home/bookmarks.tsx",
      lineNumber: 46,
      columnNumber: 7
    }, this),
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("p", { children: "There was an error in the Bookmarks route!" }, void 0, !1, {
      fileName: "app/routes/__home/bookmarks.tsx",
      lineNumber: 48,
      columnNumber: 7
    }, this)
...
function Discover({ books, usersBookmarks }) {
  ...
  return books.length ? /* @__PURE__ */ (0, import_jsx_dev_runtime13.jsxDEV)("ul", { className: "flex flex-col gap-6", "data-testid": "data", children: books == null ? void 0 : books.map((book) => !book.title || !book.image ? null : /* @__PURE__ */ (0, import_jsx_dev_runtime13.jsxDEV)(
    PreviewBookItem,
    {
      book,
      usersBookmarks,
    ...
    lineNumber: 11,
    columnNumber: 5
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime13.jsxDEV)("p", { children: "No books found" }, void 0, !1, {
    fileName: "app/components/Discover.tsx",
    lineNumber: 8,
    columnNumber: 29
  }, this);
...
function Home() {
  var _a;
  let { books, usersBookmarks } = (0, import_react12.useLoaderData)(), orderByFirstUpdate = [...(0, import_react12.useFetchers)() || []].reverse(), status = orderByFirstUpdate == null ? void 0 : orderByFirstUpdate[0];
  return /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)("div", { className: "flex items-center justify-center", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)("h1", { className: "sr-only font-monty text-xl", children: "Discover - latest!" }, void 0, !1, {
      fileName: "app/routes/__home/home.tsx",
      lineNumber: 125,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)(Discover, { books, usersBookmarks }, void 0, !1, {
      fileName: "app/routes/__home/home.tsx",
      lineNumber: 127,
      columnNumber: 7
    }, this),
    status && (status == null ? void 0 : status.type) === "done" && ((_a = status == null ? void 0 : status.data) != null && _a.message) ? /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)(Notification, { status }, void 0, !1, {
      fileName: "app/routes/__home/home.tsx",
      lineNumber: 130,
      columnNumber: 9
    }, this) : null
...
function ErrorBoundary4() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)(import_jsx_dev_runtime14.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)("h1", { children: "Oh no!" }, void 0, !1, {
      fileName: "app/routes/__home/home.tsx",
      lineNumber: 161,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime14.jsxDEV)("p", { children: "There was an error in the Discover route!" }, void 0, !1, {
      fileName: "app/routes/__home/home.tsx",
      lineNumber: 163,
      columnNumber: 7
    }, this)
...
function Reading() {
  let { userId, bookmarks } = (0, import_react13.useLoaderData)(), allBooks = bookmarks.filter((book) => book.read || book.reading);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)("div", { className: "md:p-sectionMedium", children: /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)("ul", { className: "relative my-3 mb-20 flex flex-wrap gap-6", children: allBooks.map((book, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime15.jsxDEV)(
    PreviewBookItem,
    {
      book,
      usersBookmarks: bookmarks,
...
var import_clsx = __toESM(require("clsx")), import_jsx_dev_runtime16 = require("react/jsx-dev-runtime");
function Container({ className, children }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime16.jsxDEV)("div", { className: (0, import_clsx.default)("mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", className), children }, void 0, !1, {
...
var import_jsx_dev_runtime17 = require("react/jsx-dev-runtime"), faqs = [
  [
    {
...
function Faqs() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)(
    "section",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)(Container, { className: "relative", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)("ul", { className: "mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3", children: faqs.map((column, columnIndex) => /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)("ul", { className: "flex flex-col gap-y-8", children: column.map((faq, faqIndex) => /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)("li", { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)("h3", { className: "font-display text-lg leading-7 text-slate-900", children: faq.question }, void 0, !1, {
            fileName: "app/components/Marketing/Faq.tsx",
            lineNumber: 85,
            columnNumber: 21
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime17.jsxDEV)("p", { className: "mt-4 text-sm text-slate-700", children: faq.answer }, void 0, !1, {
            fileName: "app/components/Marketing/Faq.tsx",
            lineNumber: 88,
            columnNumber: 21
          }, this)
...
function Footer() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("footer", { className: "bg-slate-50", children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(Container, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "py-16", children: /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(Logo, { className: "mx-auto h-10 w-auto" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "flex gap-x-6", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("p", { className: "mt-6 text-sm text-slate-500 sm:mt-0", children: [
        "Copyright \xA9 ",
...
var import_react14 = require("react"), import_react15 = require("@headlessui/react"), import_clsx2 = __toESM(require("clsx"));
var import_react16 = require("@remix-run/react"), import_jsx_dev_runtime20 = (
  // @ts-ignore
  require("react/jsx-dev-runtime")
);
function MobileNavLink({ href, children }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_react15.Popover.Button, { as: import_react16.Link, href, className: "block w-full p-2", children }, void 0, !1, {
...
function MobileNavigation() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_react15.Popover, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(
      import_react15.Popover.Button,
      {
        className: "relative z-10 flex h-8 w-8 items-center justify-center [&:not(:focus-visible)]:focus:outline-none",
        "aria-label": "Toggle Navigation",
        children: ({ open }) => /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(MobileNavIcon, { open }, void 0, !1, {
          fileName: "app/components/Marketing/Header.tsx",
          lineNumber: 50,
          columnNumber: 24
        }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_react15.Transition.Root, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(
        import_react15.Transition.Child,
        {
          ...
          leaveFrom: "opacity-100",
          leaveTo: "opacity-0",
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_react15.Popover.Overlay, { className: "fixed inset-0 bg-slate-300/50" }, void 0, !1, {
            fileName: "app/components/Marketing/Header.tsx",
            lineNumber: 62,
            columnNumber: 11
          }, this)
        ...
        import_react15.Transition.Child,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(
            import_react15.Popover.Panel,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(MobileNavLink, { href: "#features", children: "Features" }, void 0, !1, {
                  fileName: "app/components/Marketing/Header.tsx",
                  lineNumber: 77,
                  columnNumber: 13
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(MobileNavLink, { href: "#testimonials", children: "Testimonials" }, void 0, !1, {
                  fileName: "app/components/Marketing/Header.tsx",
                  lineNumber: 78,
                  columnNumber: 13
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(MobileNavLink, { href: "#pricing", children: "Pricing" }, void 0, !1, {
                  fileName: "app/components/Marketing/Header.tsx",
                  lineNumber: 79,
                  columnNumber: 13
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("hr", { className: "m-2 border-slate-300/40" }, void 0, !1, {
                  fileName: "app/components/Marketing/Header.tsx",
                  lineNumber: 80,
                  columnNumber: 13
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(MobileNavLink, { href: "/login", children: "Sign in" }, void 0, !1, {
                  fileName: "app/components/Marketing/Header.tsx",
                  lineNumber: 81,
                  columnNumber: 13
                }, this)
...
function Header() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("header", { className: "bg-[#36003C] py-10 text-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(Container, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("nav", { className: "relative z-50 flex justify-between", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "flex items-center md:gap-x-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_react16.Link, { to: "#", "aria-label": "Home", children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(
      "img",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "flex items-center gap-x-5 md:gap-x-8", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "hidden md:block", children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(import_react16.NavLink, { to: "/login", children: "Sign in" }, void 0, !1, {
        fileName: "app/components/Marketing/Header.tsx",
        lineNumber: 108,
        columnNumber: 15
      }, this) }, void 0, !1, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "-mr-1 md:hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(MobileNavigation, {}, void 0, !1, {
        fileName: "app/components/Marketing/Header.tsx",
        lineNumber: 116,
        columnNumber: 15
      }, this) }, void 0, !1, {
...
var React3 = __toESM(require("react")), import_react17 = require("@headlessui/react"), import_clsx3 = __toESM(require("clsx"));
var import_jsx_dev_runtime21 = require("react/jsx-dev-runtime"), features = [
  {
    title: "Discover",
  ...
  return React3.useEffect(() => {
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(Container, { className: "relative", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "max-w-2xl md:mx-auto md:text-center xl:max-w-none", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("h2", { className: "font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl", children: "The app made for book lovers by book lovers." }, void 0, !1, {
              fileName: "app/components/Marketing/SampleFeatures.tsx",
              lineNumber: 68,
              columnNumber: 11
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("p", { className: "mt-6 text-lg tracking-tight text-blue-100", children: "Find, read and spread your love for books." }, void 0, !1, {
              fileName: "app/components/Marketing/SampleFeatures.tsx",
              lineNumber: 71,
              columnNumber: 11
            }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(
            import_react17.Tab.Group,
            {
              ...
              children: ({ selectedIndex }) => /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(import_jsx_dev_runtime21.Fragment, { children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "-mx-4 flex overflow-x-auto pb-4 sm:mx-0 sm:overflow-visible sm:pb-0 lg:col-span-5", children: /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(import_react17.Tab.List, { className: "relative z-10 flex gap-x-4 whitespace-nowrap px-4 sm:mx-auto sm:px-0 lg:mx-0 lg:block lg:gap-x-0 lg:gap-y-1 lg:whitespace-normal", children: features.map((feature, featureIndex) => /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("h3", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(
                        import_react17.Tab,
                        {
                          className: (0, import_clsx3.default)(
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("span", { className: "absolute inset-0 rounded-full lg:rounded-r-none lg:rounded-l-xl" }, void 0, !1, {
                              fileName: "app/components/Marketing/SampleFeatures.tsx",
                              lineNumber: 103,
                              columnNumber: 27
                            }, this),
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(import_react17.Tab.Panels, { className: "lg:col-span-7", children: features.map((feature) => /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(import_react17.Tab.Panel, { unmount: !1, children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "relative sm:px-6 lg:hidden", children: [
                    /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "absolute -inset-x-4 top-[-6.5rem] bottom-[-4.25rem] bg-white/10 ring-1 ring-inset ring-white/10 sm:inset-x-0 sm:rounded-t-xl" }, void 0, !1, {
                      fileName: "app/components/Marketing/SampleFeatures.tsx",
                      lineNumber: 125,
                      columnNumber: 23
                    }, this),
                    /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("p", { className: "relative mx-auto max-w-2xl text-base text-white sm:text-center", children: feature.description }, void 0, !1, {
                      fileName: "app/components/Marketing/SampleFeatures.tsx",
                      lineNumber: 126,
                      columnNumber: 23
                    }, this)
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "mt-10 w-[45rem] overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]", children: /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)(
                    "img",
                    {
                      className: "w-full",
                      src: feature.image,
...
function Welcome() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)("main", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)(SampleFeatures, {}, void 0, !1, {
      fileName: "app/routes/index.tsx",
      lineNumber: 21,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime22.jsxDEV)(Faqs, {}, void 0, !1, {
      fileName: "app/routes/index.tsx",
      lineNumber: 22,
      columnNumber: 7
    }, this),
...
var import_node12 = require("@remix-run/node"), import_node13 = require("@remix-run/node"), import_react20 = require("@remix-run/react");

// app/components/AuthenticateForm.tsx
var React4 = __toESM(require("react")), import_fa = require("react-icons/fa"), import_ai = require("react-icons/ai"), import_react18 = require("@remix-run/react"), import_jsx_dev_runtime23 = require("react/jsx-dev-runtime");
function AuthenticateForm({ error }) {
  let { supabase } = (0, import_react18.useOutletContext)(), [redirectTo, setRedirectTo] = React4.useState(null);
  return React4.useEffect(() => {
    var _a;
    window && setRedirectTo(`${(_a = window == null ? void 0 : window.location) == null ? void 0 : _a.origin}/oauth/callback/`);
  }, []), /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("div", { className: "mb-10 rounded-t-md border-t-[1px]", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("h2", { className: "mb-5 mt-10 pb-3", children: "Or sign in with:" }, void 0, !1, {
      fileName: "app/components/AuthenticateForm.tsx",
      lineNumber: 24,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("div", { children: [
      (error == null ? void 0 : error.message) && /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("div", { children: error.message }, void 0, !1, {
        fileName: "app/components/AuthenticateForm.tsx",
        lineNumber: 27,
        columnNumber: 28
      }, this),
      redirectTo ? /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("ul", { className: "social-logins mx-auto flex max-w-[300px] justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(import_fa.FaSpotify, { className: "text-lg lm:text-xl md:text-2xl" }, void 0, !1, {
              fileName: "app/components/AuthenticateForm.tsx",
              lineNumber: 40,
              columnNumber: 17
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(import_ai.AiOutlineGoogle, { className: "text-lg lm:text-xl md:text-2xl" }, void 0, !1, {
              fileName: "app/components/AuthenticateForm.tsx",
              lineNumber: 53,
              columnNumber: 17
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(import_fa.FaTwitter, { className: "text-lg lm:text-xl md:text-2xl" }, void 0, !1, {
              fileName: "app/components/AuthenticateForm.tsx",
              lineNumber: 66,
              columnNumber: 17
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(import_fa.FaFacebookF, { className: "text-lg lm:text-xl md:text-2xl" }, void 0, !1, {
              fileName: "app/components/AuthenticateForm.tsx",
              lineNumber: 79,
              columnNumber: 17
            }, this)
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)("li", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_dev_runtime23.jsxDEV)(import_fa.FaGithub, { className: "text-lg lm:text-xl md:text-2xl" }, void 0, !1, {
              fileName: "app/components/AuthenticateForm.tsx",
              lineNumber: 92,
              columnNumber: 17
            }, this)
...
function AuthLayout({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)(import_jsx_dev_runtime24.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "relative flex min-h-full justify-center md:px-12 lg:px-0", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "relative z-10 flex flex-1 flex-col bg-white py-10 px-4 shadow-2xl sm:justify-center md:flex-none md:px-28", children: /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "mx-auto w-full max-w-md sm:px-4 md:w-96 md:max-w-sm md:px-0", children }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)("div", { className: "hidden sm:contents lg:relative lg:block lg:flex-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime24.jsxDEV)(
      "img",
      {
...
function TextField({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)("div", { className, children: [
    label && /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)(Label, { id, children: label }, void 0, !1, {
      fileName: "app/components/Fields.tsx",
      lineNumber: 28,
      columnNumber: 17
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime25.jsxDEV)("input", { id, type, ...props, className: formClasses }, void 0, !1, {
      fileName: "app/components/Fields.tsx",
      lineNumber: 29,
      columnNumber: 7
    }, this)
...
function LoginWithEmail() {
  var _a, _b;
  let data = (0, import_react19.useActionData)(), errors = (0, import_react19.useActionData)(), isSubmitting = (0, import_react19.useNavigation)().state === "submitting";
  return /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)(
    import_react19.Form,
    {
      ...
      children: !(errors != null && errors.email) && data ? /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("p", { children: "Success! Go ahead and click the link in your email!" }, void 0, !1, {
        ...
        ((_b = data == null ? void 0 : data.errors) == null ? void 0 : _b.email) && /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("p", { children: "Please submit a valid email address" }, void 0, !1, {
          fileName: "app/components/LoginWithEmail.tsx",
          lineNumber: 31,
          columnNumber: 35
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)(
          "button",
          {
            ...
            children: [
              ...
              isSubmitting ? null : /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("span", { children: [
                "Request a login link ",
                /* @__PURE__ */ (0, import_jsx_dev_runtime26.jsxDEV)("span", { "aria-hidden": "true", children: "\u2192" }, void 0, !1, {
                  fileName: "app/components/LoginWithEmail.tsx",
                  lineNumber: 41,
                  columnNumber: 40
                }, this)
...
// app/routes/login.tsx
var import_jsx_dev_runtime27 = require("react/jsx-dev-runtime"), action4 = async ({ request }) => {
...
function Login() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(import_jsx_dev_runtime27.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(AuthLayout, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(import_react20.Link, { to: "/", "aria-label": "Home", children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(Logo, { className: "h-10 w-auto" }, void 0, !1, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("div", { className: "mt-20", children: /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)("h2", { className: "text-lg font-semibold text-gray-900", children: "Sign in to get access" }, void 0, !1, {
        fileName: "app/routes/login.tsx",
        lineNumber: 68,
        columnNumber: 13
      }, this) }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(LoginWithEmail, {}, void 0, !1, {
      fileName: "app/routes/login.tsx",
      lineNumber: 73,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime27.jsxDEV)(AuthenticateForm, { error }, void 0, !1, {
      fileName: "app/routes/login.tsx",
      lineNumber: 74,
      columnNumber: 9
    }, this)
...
var assets_manifest_default = { version: "9195c2fd", entry: { module: "http://localhost:3001/build/entry.client-VAVR3Q5U.js", imports: ["http://localhost:3001/build/_shared/chunk-6LQ3I3ZQ.js", "http://localhost:3001/build/_shared/chunk-TKNRDOWK.js", "http://localhost:3001/build/_shared/chunk-FTAWBYAR.js", "http://localhost:3001/build/_shared/chunk-IZMOKZCZ.js", "http://localhost:3001/build/_shared/chunk-EMA65K2Y.js", "http://localhost:3001/build/_shared/chunk-4LTUZW6F.js", "http://localhost:3001/build/_shared/chunk-Y6OKQBE4.js", "http://localhost:3001/build/_shared/chunk-V65KVDQ6.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/root-JZ6E6PE5.js", imports: ["http://localhost:3001/build/_shared/chunk-ZZTX2XQN.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/__home": { id: "routes/__home", parentId: "root", path: void 0, index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/__home-CXMGYXLD.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/__home/bookmarks": { id: "routes/__home/bookmarks", parentId: "routes/__home", path: "bookmarks", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/__home/bookmarks-EBNM4MKZ.js", imports: ["http://localhost:3001/build/_shared/chunk-B5F37VI7.js", "http://localhost:3001/build/_shared/chunk-LXYW6MVA.js", "http://localhost:3001/build/_shared/chunk-ZZTX2XQN.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/__home/home": { id: "routes/__home/home", parentId: "routes/__home", path: "home", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/__home/home-R47W5DR5.js", imports: ["http://localhost:3001/build/_shared/chunk-UFZF43DV.js", "http://localhost:3001/build/_shared/chunk-S2766ERN.js", "http://localhost:3001/build/_shared/chunk-B5F37VI7.js", "http://localhost:3001/build/_shared/chunk-LXYW6MVA.js", "http://localhost:3001/build/_shared/chunk-ZZTX2XQN.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/__home/read": { id: "routes/__home/read", parentId: "routes/__home", path: "read", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/__home/read-MVV25YCY.js", imports: ["http://localhost:3001/build/_shared/chunk-B5F37VI7.js", "http://localhost:3001/build/_shared/chunk-LXYW6MVA.js", "http://localhost:3001/build/_shared/chunk-ZZTX2XQN.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/book/$id": { id: "routes/book/$id", parentId: "root", path: "book/:id", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/book/$id-LNBP2HKW.js", imports: ["http://localhost:3001/build/_shared/chunk-UFZF43DV.js", "http://localhost:3001/build/_shared/chunk-S2766ERN.js", "http://localhost:3001/build/_shared/chunk-LXYW6MVA.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/index-ZWI4RX7R.js", imports: ["http://localhost:3001/build/_shared/chunk-OTEP5B35.js", "http://localhost:3001/build/_shared/chunk-S2766ERN.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/login": { id: "routes/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/login-MAFZZUKN.js", imports: ["http://localhost:3001/build/_shared/chunk-OTEP5B35.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/logout-AOAWQZH6.js", imports: void 0, hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/oauth.callback": { id: "routes/oauth.callback", parentId: "root", path: "oauth/callback", index: void 0, caseSensitive: void 0, module: "http://localhost:3001/build/routes/oauth.callback-F6QLGSK7.js", imports: ["http://localhost:3001/build/_shared/chunk-K4G2CLKP.js"], hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, cssBundleHref: void 0, hmr: { runtime: "http://localhost:3001/build/_shared/chunk-EMA65K2Y.js", routes: { "app/root.tsx": { loaderHash: `// import tailwindStyles from "~/tailwind.css";
...
export const loader = async ({
  ...
  return {};
};` }, "app/routes/__home/home.tsx": { loaderHash: `export async function loader({
  request
}: LoaderArgs) {
  const {
    session
  ...
  return json(data);
}` }, "app/routes/book/$id.tsx": { loaderHash: `export async function loader({
  request,
  params
}: LoaderArgs) {
  const {
...
}` }, "app/routes/__home.tsx": { loaderHash: `export async function loader({
  request
}: LoaderArgs) {
  const {
    session
  ...
  if (!session) return redirect(FAILURE_REDIRECT);
  return json({});
}` }, "app/routes/__home/read.tsx": { loaderHash: `export async function loader({
  request
}: LoaderArgs) {
  const {
    session
...
}` }, "app/routes/login.tsx": { loaderHash: `export async function loader({
  request
}: LoaderArgs) {
  const {
    session,
...
}` }, "app/routes/__home/bookmarks.tsx": { loaderHash: `export async function loader({
  request
}: LoaderArgs) {
  const {
    session
  ...
  if (session) return redirect(SUCCESS_REDIRECT);
  return {};
}` } }, timestamp: 1683541715797 }, url: "http://localhost:3001/build/manifest-9195C2FD.js" };

// server-entry-module:@remix-run/dev/server-build
var assetsBuildDirectory = "./public/build", future = { unstable_dev: !0, unstable_postcss: !1, unstable_tailwind: !1, v2_errorBoundary: !0, v2_meta: !0, v2_normalizeFormMethod: !0, v2_routeConvention: !1 }, publicPath = "http://localhost:3001/build/", entry = { module: entry_server_react_stream_exports }, dev = { websocketPort: 3002 }, routes = {
  root: {
    id: "root",
    parentId: void 0,
    path: "",
